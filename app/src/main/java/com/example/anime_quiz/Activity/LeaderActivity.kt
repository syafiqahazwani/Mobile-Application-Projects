...
import com.example.anime_quiz.Adapter.LeaderAdapter
import com.example.anime_quiz.Domain.UserModel
import com.example.anime_quiz.R
import com.example.anime_quiz.databinding.ActivityLeaderBinding
...
class LeaderActivity : AppCompatActivity() {
    ...
    private fun loadData():MutableList<UserModel>{
        ...
        users.add(UserModel(9,"Katnis Everdeen","person9",2380))
        return users
    }
}
