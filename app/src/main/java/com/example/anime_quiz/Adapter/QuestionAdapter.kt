package com.example.anime_quiz.Adapter
...
import com.example.anime_quiz.databinding.ViewholderQuestionBinding
...
class QuestionAdapter(
    ...
    override fun onBindViewHolder(holder: QuestionAdapter.ViewHolder, position: Int) {
        ...
        if (differ.currentList.size == 0 && currectPos == position) {
