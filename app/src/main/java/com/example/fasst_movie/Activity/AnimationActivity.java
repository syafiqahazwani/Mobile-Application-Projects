...
import com.example.fasst_movie.databinding.ActivityAnimationBinding;
...
public class AnimationActivity extends AppCompatActivity {
    ...
    private void bottomMenu() {
        ...
        superhero.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(AnimationActivity.this, SuperheroActivity.class));
            }
        });
        magic.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(AnimationActivity.this, MagicActivity.class));
            }
        });
    ...
    private void initAnimationMovie() {
        DatabaseReference myRef = database.getReference("Animationmovie");
        ...
        myRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    if (!items.isEmpty()) {
                        binding.recyclerView10.setLayoutManager(new LinearLayoutManager(AnimationActivity.this,
                                LinearLayoutManager.HORIZONTAL, false));
                        binding.recyclerView10.setAdapter(new FilmListAdapter(items));
                    }
